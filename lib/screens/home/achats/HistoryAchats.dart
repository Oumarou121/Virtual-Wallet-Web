...
class HistoryAchats extends StatefulWidget {
  HistoryAchats({super.key, required this.MyUid, required this.userData});
  final MyUid;
  final AppUserData userData;
  @override
  State<HistoryAchats> createState() => _HistoryAchatsState();
}

class _HistoryAchatsState extends State<HistoryAchats> {
  ...
  Widget build(BuildContext context) {
    var collection = FirebaseFirestore.instance
        .collection('History ${widget.MyUid}')
