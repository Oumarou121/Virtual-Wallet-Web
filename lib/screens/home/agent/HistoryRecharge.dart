...
class HistoryRecharge extends StatefulWidget {
  HistoryRecharge({super.key, required this.MyUid, required this.userData});
  final String MyUid;
  final AppUserData userData;
  @override
  State<HistoryRecharge> createState() => _HistoryRechargeState();
}

class _HistoryRechargeState extends State<HistoryRecharge> {
        ...
        children: <Widget>[
          Column(
            children: [
              ...
              _imputNameS(
                  PlayerNameS
                      : items['Name'], userData: widget.userData),
              const SizedBox(height: 20),
              _imputNumberS(
                  PlayerNumberS
                      : items['Phone'], userData: widget.userData),
              const SizedBox(height: 20),
              _imputAmount(
    ...
    return Container(
      ...
      child: Center(
          child: Text(
            SwicthLangues(
                userData: userData,
                fr: "Numéro du client :  $PlayerNumberS",
    ...
    return Container(
      ...
      child: Center(
          child: Text(
            SwicthLangues(
                userData: userData,
                fr: 'Montant de recharge :  $PlayerAmount',
  ...
  Widget build(BuildContext context) {
    var collection = FirebaseFirestore.instance
        .collection('Recharge ${widget.MyUid}')
