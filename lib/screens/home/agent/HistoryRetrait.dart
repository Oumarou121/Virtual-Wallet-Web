...
class HistoryRetrait extends StatefulWidget {
  HistoryRetrait({super.key, required this.MyUid, required this.userData});
  final String MyUid;
  final AppUserData userData;
  @override
  State<HistoryRetrait> createState() => _HistoryRetraitState();
}

class _HistoryRetraitState extends State<HistoryRetrait> {
    ...
    return Container(
      ...
      child: Center(
          child: Text(
            SwicthLangues(
                userData: userData,
                fr: 'Montant du retrait :  $PlayerAmount',
  ...
  Widget build(BuildContext context) {
    var collection = FirebaseFirestore.instance
        .collection('Retrait ${widget.MyUid}')
